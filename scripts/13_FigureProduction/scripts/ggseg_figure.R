...
for (i in 1:nrow(new_data_F)) {
  ...
  if (area %in% PFITregions) { pfitstat <- "PFIT" } else { pfitstat <- "Not" }
...
final_data$Count2 <- factor(final_data$Count2, levels=c("0 Non-PFIT", "1 Non-PFIT", "2 Non-PFIT",
  "3 Non-PFIT", "4 Non-PFIT", "5 Non-PFIT", "6 Non-PFIT", "0 PFIT", "1 PFIT", "2 PFIT",
