...
volume.data.1$ageBin <- revalue(volume.data.1$ageBin, replace=c('Early Adulthood'="55.1-85",'Adolescence'='21.1-55','Childhood'='12-21'))
...
gmd.data.1$ageBin <- revalue(gmd.data.1$ageBin, replace=c('Early Adulthood'="55.1-85",'Adolescence'='21.1-55','Childhood'='12-21'))
...
ct.data.1$ageBin <- revalue(ct.data.1$ageBin, replace=c('Early Adulthood'="55.1-85",'Adolescence'='21.1-55','Childhood'='12-21'))
...
pdf('mgiAgeTrends.pdf',height=20, width=20)
volumePlot
gmdPlot
ctPlot
dev.off()
